ATTACH TABLE _ UUID '23f824de-1e2b-4468-9242-ebe368ac093a'
(
    ...
    `ProfileEvent_ApplyPatchesMicroseconds` UInt64 COMMENT 'Total time spent applying patch parts',
    `ProfileEvent_ApplyPatchesMergeMicroseconds` UInt64 COMMENT 'Total time spent applying patch parts with Merge mode',
    `ProfileEvent_ApplyPatchesJoinMicroseconds` UInt64 COMMENT 'Total time spent applying patch parts with Join mode',
